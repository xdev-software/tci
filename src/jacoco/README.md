...
Please have a look at the [advanced-demo](../../demos/advanced-demo/) and the corresponding [GitHub Actions workflow](../../.github/workflows/run-integration-tests.yml) for details.
